...
if ( ! defined( 'LEARNDASH_BBPRESS_VERSION' ) ) {
	define( 'LEARNDASH_BBPRESS_VERSION', '2.2.0' );
}
...
class Learndash_BBPress {
	...
	public function admin_enqueue_scripts()
	{
		...
		if ( $screen->post_type === 'forum' ) {
			...
			wp_enqueue_style( 'learndash-bbpress-select2-styles', LEARNDASH_BBPRESS_PLUGIN_URL . 'assets/css/select2.css', [ 'learndash-select2-jquery-style' ], LEARNDASH_BBPRESS_VERSION, 'all' );
		}
	}
